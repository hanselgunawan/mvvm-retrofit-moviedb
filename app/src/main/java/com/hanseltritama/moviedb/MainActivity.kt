...
import com.hanseltritama.moviedb.data.PopularMoviePagedListAdapter
...
import com.hanseltritama.moviedb.viewmodel.MainActivityViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.movidPagedList.observe(this, Observer {
